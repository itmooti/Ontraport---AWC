...
ID: field(arg: ["id"]) 
submissionTotalCount: countDistinct(args: [{ field: ["Assessments", "Submissions", "id"] }])
...
<div class="text-dark extra-small-text serif line-clamp-1">${lesson.submissionTotalCount || 0} Submissions ${lesson.Class_Student_Enrolements} Students</div>`;
