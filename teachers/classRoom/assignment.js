...
`;
    ...
    try {
        ...
        lessons.forEach(async (lesson) => {
            ...
            assignmentDiv.href = (lesson.Assessments_AWC_Teacher_s_Portal_Class_Assignment_Details_Page_URL || "#") + "?duedate=" + encodeURIComponent(dueDate ? formatDueString(dueDate) : "No Due Date");
