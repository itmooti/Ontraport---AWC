  ...
  `;
    card.addEventListener("click", async function () {
        ...
        if (type === "Posts" || type === "Post Comments") {
            ...
            window.location.href = `https://courses.writerscentre.com.au/students/course-details/${notification.Course_Unique_ID}?&selectedTab=announcements?data-announcement-template-id=${anouncementScrollId}`;
        }
    });
    return card;
}
